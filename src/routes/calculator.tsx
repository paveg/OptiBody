...
import { healthCalculator, type UserMetrics, type CalculationResult, type Gender, type ActivityLevel, HealthCalculator } from '~/lib/health-calculators';
...
function CalculatorPage() {
  ...
  const handleCalculate = () => {
    ...
    try {
      const result = healthCalculator.calculateBMRAndTDEE(metrics as UserMetrics);
      setResult(result);
    } catch (error) {
  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-xl font-semibold mb-6">あなたの情報を入力してください</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setMetrics({ ...metrics, gender: value as Gender })}
            >
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setMetrics({ ...metrics, activityLevel: value as ActivityLevel })}
            >
              <SelectTrigger className="w-full">
        ...
        <div className="bg-blue-50 rounded-lg shadow-md p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-white rounded">
              ...
              <span className="text-2xl font-bold text-blue-600">{result.bmr} kcal/日</span>
            </div>
            
            <div className="flex justify-between items-center p-3 bg-white rounded">
              <span className="font-medium">総消費エネルギー (TDEE)</span>
              <span className="text-2xl font-bold text-green-600">{result.tdee} kcal/日</span>
            </div>
            
            <div className="text-sm text-gray-600 mt-4">
              <p>計算式: {result.formula}</p>
              <p className="mt-2">
                BMR: 安静時に消費される最小限のエネルギー<br />
